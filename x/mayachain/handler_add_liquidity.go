...
func (h AddLiquidityHandler) validateV123(ctx cosmos.Context, msg MsgAddLiquidity) error {
...
func (h AddLiquidityHandler) handleV112(ctx cosmos.Context, msg MsgAddLiquidity) (errResult error) {
