...
// newNetworkMgrV108 create a new vault manager
func newNetworkMgrV108(k keeper.Keeper, txOutStore TxOutStore, eventMgr EventManager) *NetworkMgrV108 {
	return &NetworkMgrV108{
		k:          k,
		txOutStore: txOutStore,
		eventMgr:   eventMgr,
	}
...
func (vm *NetworkMgrV108) processGenesisSetup(ctx cosmos.Context) error {
...
func (vm *NetworkMgrV108) paySaverYield(ctx cosmos.Context, asset common.Asset, runeAmt cosmos.Uint) error {
...
func (mv *NetworkMgrV108) fetchPOLPools(ctx cosmos.Context, mgr Manager) Pools {
	var pools Pools
...
func (vm *NetworkMgrV108) addPOLLiquidity(
	ctx cosmos.Context,
	pool Pool,
...
func (vm *NetworkMgrV108) removePOLLiquidity(
	ctx cosmos.Context,
	pool Pool,
	polAddress, asgardAddress common.Address,
	signer cosmos.AccAddress,
...
func (vm *NetworkMgrV108) cleanupAsgardIndex(ctx cosmos.Context) error {
...
// and ragnaroks them
func (vm *NetworkMgrV108) manageChains(ctx cosmos.Context, mgr Manager) error {
...
// ragnarok'ed
func (vm *NetworkMgrV108) findChainsToRetire(ctx cosmos.Context) (common.Chains, error) {
...
func (vm *NetworkMgrV108) ragnarokChain(ctx cosmos.Context, chain common.Chain, nth int64, mgr Manager) error {
...
func (vm *NetworkMgrV108) withdrawLiquidity(ctx cosmos.Context, pool Pool, na NodeAccount, mgr Manager) error {
	if pool.Status == PoolSuspended {
...
func (vm *NetworkMgrV108) UpdateNetwork(ctx cosmos.Context, constAccessor constants.ConstantValues, gasManager GasManager, eventMgr EventManager) error {
	...
	rewardEvt := NewEventRewardsV1(bondReward, evtPools)
...
func (vm *NetworkMgrV108) getTotalProvidedLiquidityRune(ctx cosmos.Context) (Pools, cosmos.Uint, error) {
...
func (vm *NetworkMgrV108) getTotalActiveBond(ctx cosmos.Context) (cosmos.Uint, error) {
...
// Pays out Rewards
func (vm *NetworkMgrV108) payPoolRewards(ctx cosmos.Context, poolRewards []cosmos.Uint, pools Pools) error {
	for i, reward := range poolRewards {
		...
		if err := vm.paySaverYield(ctx, pools[i].Asset, reward); err != nil {
...
func (vm *NetworkMgrV108) calcPoolDeficit(lpDeficit, totalFees, poolFees cosmos.Uint) cosmos.Uint {
...
func (vm *NetworkMgrV108) calcBlockRewards(ctx cosmos.Context, totalProvidedLiquidity, totalBonded, totalLiquidityFees cosmos.Uint) (cosmos.Uint, cosmos.Uint) {
...
func (vm *NetworkMgrV108) deductPoolRewardDeficit(ctx cosmos.Context, pools Pools, totalLiquidityFees, lpDeficit cosmos.Uint) ([]PoolAmt, error) {
...
func (vm *NetworkMgrV108) checkPoolRagnarok(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV108) canRagnarokGasPool(ctx cosmos.Context, c common.Chain, allPools Pools) bool {
...
func (vm *NetworkMgrV108) redeemSynthAssetToReserve(ctx cosmos.Context, p Pool) error {
...
func (vm *NetworkMgrV108) ragnarokPool(ctx cosmos.Context, mgr Manager, p Pool) error {
