...
type SwapQueueV110Suite struct{}

var _ = Suite(&SwapQueueV110Suite{})

func (s SwapQueueV110Suite) TestGetTodoNum(c *C) {
	queue := newSwapQueueV110(keeper.KVStoreDummy{})
...
func (s SwapQueueV110Suite) TestScoreMsgs(c *C) {
...
func (s SwapQueueV110Suite) TestStreamingSwapSelection(c *C) {
