...
func (k *WithdrawTestKeeperV105) SendFromModuleToModule(ctx cosmos.Context, from, to string, coins common.Coins) error {
	// Just return nil to allow the test to proceed
	// This simulates successful module-to-module transfer
	return nil
}

func (k *WithdrawTestKeeperV105) GetTotalSupply(ctx cosmos.Context, asset common.Asset) cosmos.Uint {
	// Return zero for synthetic assets in tests
	return cosmos.ZeroUint()
}

func (k *WithdrawTestKeeperV105) RagnarokInProgress(ctx cosmos.Context) bool {
