...
// TxOutStorageV110 is going to manage all the outgoing tx
type TxOutStorageV110 struct {
...
// newTxOutStorageV110 will create a new instance of TxOutStore.
func newTxOutStorageV110(keeper keeper.Keeper, constAccessor constants.ConstantValues, eventMgr EventManager, gasManager GasManager) *TxOutStorageV110 {
	return &TxOutStorageV110{
		keeper:        keeper,
		eventMgr:      eventMgr,
...
func (tos *TxOutStorageV110) EndBlock(ctx cosmos.Context, mgr Manager) error {
...
func (tos *TxOutStorageV110) GetBlockOut(ctx cosmos.Context) (*TxOut, error) {
	return tos.keeper.GetTxOut(ctx, ctx.BlockHeight())
}

// GetOutboundItems read all the outbound item from kv store
func (tos *TxOutStorageV110) GetOutboundItems(ctx cosmos.Context) ([]TxOutItem, error) {
...
func (tos *TxOutStorageV110) GetOutboundItemByToAddress(ctx cosmos.Context, to common.Address) []TxOutItem {
...
func (tos *TxOutStorageV110) ClearOutboundItems(ctx cosmos.Context) {
...
func (tos *TxOutStorageV110) TryAddTxOutItem(ctx cosmos.Context, mgr Manager, toi TxOutItem, minOut cosmos.Uint) (bool, error) {
...
func (tos *TxOutStorageV110) cachedTryAddTxOutItem(ctx cosmos.Context, mgr Manager, toi TxOutItem, minOut cosmos.Uint) (bool, error) {
...
// fee deduction, etc
func (tos *TxOutStorageV110) UnSafeAddTxOutItem(ctx cosmos.Context, mgr Manager, toi TxOutItem, height int64) error {
	return tos.addToBlockOut(ctx, mgr, toi, height)
}

func (tos *TxOutStorageV110) discoverOutbounds(ctx cosmos.Context, transactionFeeAsset cosmos.Uint, maxGasAsset common.Coin, toi TxOutItem, vaults Vaults) ([]TxOutItem, cosmos.Uint) {
...
func (tos *TxOutStorageV110) prepareTxOutItem(ctx cosmos.Context, toi TxOutItem) ([]TxOutItem, cosmos.Uint, error) {
	var outputs []TxOutItem
...
func (tos *TxOutStorageV110) addToBlockOut(ctx cosmos.Context, mgr Manager, item TxOutItem, outboundHeight int64) error {
...
func (tos *TxOutStorageV110) CalcTxOutHeight(ctx cosmos.Context, version semver.Version, toi TxOutItem) (int64, error) {
...
func (tos *TxOutStorageV110) nativeTxOut(ctx cosmos.Context, mgr Manager, toi TxOutItem) error {
...
func (tos *TxOutStorageV110) collectYggdrasilPools(ctx cosmos.Context, tx ObservedTx, gasAsset common.Asset) (Vaults, error) {
...
func (tos *TxOutStorageV110) getPendingOutbounds(ctx cosmos.Context, asset common.Asset) []TxOutItem {
...
func (tos *TxOutStorageV110) deductVaultPendingOutbounds(vault Vault, pendingOutbounds []TxOutItem) Vault {
