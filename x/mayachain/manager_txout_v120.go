...
// TxOutStorageV120 is going to manage all the outgoing tx
type TxOutStorageV120 struct {
...
// newTxOutStorageV120 will create a new instance of TxOutStore.
func newTxOutStorageV120(keeper keeper.Keeper, constAccessor constants.ConstantValues, eventMgr EventManager, gasManager GasManager) *TxOutStorageV120 {
	return &TxOutStorageV120{
		keeper:        keeper,
		eventMgr:      eventMgr,
...
func (tos *TxOutStorageV120) EndBlock(ctx cosmos.Context, mgr Manager) error {
...
func (tos *TxOutStorageV120) GetBlockOut(ctx cosmos.Context) (*TxOut, error) {
	return tos.keeper.GetTxOut(ctx, ctx.BlockHeight())
}

// GetOutboundItems read all the outbound item from kv store
func (tos *TxOutStorageV120) GetOutboundItems(ctx cosmos.Context) ([]TxOutItem, error) {
...
func (tos *TxOutStorageV120) GetOutboundItemByToAddress(ctx cosmos.Context, to common.Address) []TxOutItem {
...
func (tos *TxOutStorageV120) ClearOutboundItems(ctx cosmos.Context) {
...
func (tos *TxOutStorageV120) TryAddTxOutItem(ctx cosmos.Context, mgr Manager, toi TxOutItem, minOut cosmos.Uint) (bool, error) {
...
func (tos *TxOutStorageV120) takeAffiliateFee(ctx cosmos.Context, mgr Manager, toi TxOutItem) (cosmos.Uint, error) {
...
func (tos *TxOutStorageV120) cachedTryAddTxOutItem(ctx cosmos.Context, mgr Manager, toi TxOutItem, minOut cosmos.Uint) (bool, error) {
...
// fee deduction, etc
func (tos *TxOutStorageV120) UnSafeAddTxOutItem(ctx cosmos.Context, mgr Manager, toi TxOutItem, height int64) error {
	if toi.ToAddress.IsNoop() {
		return nil
	}
...
func (tos *TxOutStorageV120) discoverOutbounds(ctx cosmos.Context, transactionFeeAsset cosmos.Uint, maxGasAsset common.Coin, toi TxOutItem, vaults Vaults) ([]TxOutItem, cosmos.Uint) {
...
func (tos *TxOutStorageV120) prepareTxOutItem(ctx cosmos.Context, toi TxOutItem) ([]TxOutItem, cosmos.Uint, error) {
	var outputs []TxOutItem
...
func (tos *TxOutStorageV120) addToBlockOut(ctx cosmos.Context, mgr Manager, item TxOutItem, outboundHeight int64) error {
...
func (tos *TxOutStorageV120) CalcTxOutHeight(ctx cosmos.Context, version semver.Version, toi TxOutItem) (int64, error) {
...
func (tos *TxOutStorageV120) nativeTxOut(ctx cosmos.Context, mgr Manager, toi TxOutItem) error {
...
func (tos *TxOutStorageV120) collectYggdrasilPools(ctx cosmos.Context, tx ObservedTx, gasAsset common.Asset) (Vaults, error) {
