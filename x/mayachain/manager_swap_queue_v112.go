...
// SwapQueueV112 is going to manage the swaps queue
type SwapQueueV112 struct {
	k keeper.Keeper
}

// newSwapQueueV112 create a new vault manager
func newSwapQueueV112(k keeper.Keeper) *SwapQueueV112 {
	return &SwapQueueV112{k: k}
}

// FetchQueue - grabs all swap queue items from the kvstore and returns them
func (vm *SwapQueueV112) FetchQueue(ctx cosmos.Context, mgr Manager) (swapItems, error) { // nolint
...
func (vm *SwapQueueV112) EndBlock(ctx cosmos.Context, mgr Manager) error {
...
func (vm *SwapQueueV112) getTodoNum(queueLen, minSwapsPerBlock, maxSwapsPerBlock int64) int64 {
...
// swapItem list
func (vm *SwapQueueV112) scoreMsgs(ctx cosmos.Context, items swapItems, synthVirtualDepthMult int64, mgr Manager) (swapItems, error) {
...
func (vm *SwapQueueV112) getLiquidityFeeAndSlip(ctx cosmos.Context, pool Pool, sourceCoin common.Coin, item *swapItem, virtualDepthMult int64, mgr Manager) {
