...
type TestRagnarokChainKeeperV107 struct {
	keeper.KVStoreDummy
	activeVault Vault
	retireVault Vault
	yggVault    Vault
...
func (k *TestRagnarokChainKeeperV107) ListValidatorsWithBond(_ cosmos.Context) (NodeAccounts, error) {
	return NodeAccounts{k.na}, k.err
}

func (k *TestRagnarokChainKeeperV107) ListActiveValidators(_ cosmos.Context) (NodeAccounts, error) {
	return NodeAccounts{k.na}, k.err
}

func (k *TestRagnarokChainKeeperV107) GetNodeAccount(ctx cosmos.Context, signer cosmos.AccAddress) (NodeAccount, error) {
...
func (k *TestRagnarokChainKeeperV107) GetAsgardVaultsByStatus(_ cosmos.Context, vt VaultStatus) (Vaults, error) {
	if vt == ActiveVault {
...
func (k *TestRagnarokChainKeeperV107) VaultExists(_ cosmos.Context, _ common.PubKey) bool {
	return true
}

func (k *TestRagnarokChainKeeperV107) GetVault(_ cosmos.Context, _ common.PubKey) (Vault, error) {
	return k.yggVault, k.err
}

func (k *TestRagnarokChainKeeperV107) GetMostSecure(ctx cosmos.Context, vaults Vaults, signingTransPeriod int64) Vault {
	return vaults[0]
}

func (k *TestRagnarokChainKeeperV107) GetLeastSecure(ctx cosmos.Context, vaults Vaults, signingTransPeriod int64) Vault {
	return vaults[0]
}

func (k *TestRagnarokChainKeeperV107) GetPools(_ cosmos.Context) (Pools, error) {
	return k.pools, k.err
}

func (k *TestRagnarokChainKeeperV107) GetPool(_ cosmos.Context, asset common.Asset) (Pool, error) {
...
func (k *TestRagnarokChainKeeperV107) SetPool(_ cosmos.Context, pool Pool) error {
...
func (k *TestRagnarokChainKeeperV107) PoolExist(_ cosmos.Context, _ common.Asset) bool {
	return true
}

func (k *TestRagnarokChainKeeperV107) GetLiquidityProviderIterator(ctx cosmos.Context, _ common.Asset) cosmos.Iterator {
	cdc := makeTestCodec()
...
func (k *TestRagnarokChainKeeperV107) AddOwnership(ctx cosmos.Context, coin common.Coin, addr cosmos.AccAddress) error {
	lp, _ := common.NewAddress(addr.String(), GetCurrentVersion())
...
func (k *TestRagnarokChainKeeperV107) RemoveOwnership(ctx cosmos.Context, coin common.Coin, addr cosmos.AccAddress) error {
	lp, _ := common.NewAddress(addr.String(), GetCurrentVersion())
	for i, skr := range k.lps {
		if lp.Equals(skr.CacaoAddress) {
...
func (k *TestRagnarokChainKeeperV107) GetLiquidityProvider(_ cosmos.Context, asset common.Asset, addr common.Address) (LiquidityProvider, error) {
...
func (k *TestRagnarokChainKeeperV107) SetLiquidityProvider(_ cosmos.Context, lp LiquidityProvider) {
	for i, skr := range k.lps {
...
func (k *TestRagnarokChainKeeperV107) RemoveLiquidityProvider(_ cosmos.Context, lp LiquidityProvider) {
	for i, skr := range k.lps {
		if lp.CacaoAddress.Equals(skr.CacaoAddress) {
...
func (k *TestRagnarokChainKeeperV107) GetGas(_ cosmos.Context, _ common.Asset) ([]cosmos.Uint, error) {
	return []cosmos.Uint{cosmos.NewUint(10)}, k.err
}

func (k *TestRagnarokChainKeeperV107) GetLowestActiveVersion(_ cosmos.Context) semver.Version {
	return GetCurrentVersion()
}

func (k *TestRagnarokChainKeeperV107) AddPoolFeeToReserve(_ cosmos.Context, _ cosmos.Uint) error {
	return k.err
}

func (k *TestRagnarokChainKeeperV107) IsActiveObserver(_ cosmos.Context, _ cosmos.AccAddress) bool {
	return true
}
...
func (s *NetworkManagerV107TestSuite) TestRagnarokChain(c *C) {
	...
	keeper := &TestRagnarokChainKeeperV107{
	...
	helper := NewVaultGenesisSetupTestHelperV107(mgr1.Keeper())
	mgr.K = helper
...
func (s *NetworkManagerV107TestSuite) TestUpdateNetwork(c *C) {
	...
	helper := NewVaultGenesisSetupTestHelperV107(mgr.Keeper())
	mgr.K = helper
	...
	SetupLiquidityBondForTestV105(c, ctx, mgr.Keeper(), common.BTCAsset, na.BondAddress, na, cosmos.NewUint(100*common.One))
	na1 := GetRandomValidatorNode(NodeActive)
	c.Assert(helper.Keeper.SetNodeAccount(ctx, na1), IsNil)
	SetupLiquidityBondForTestV105(c, ctx, mgr.Keeper(), common.BTCAsset, na1.BondAddress, na1, cosmos.NewUint(100*common.One))
	c.Assert(networkMgr.UpdateNetwork(ctx, constAccessor, mgr.GasMgr(), mgr.EventMgr()), IsNil)
...
type VaultManagerTestHelpKeeperV107 struct {
	keeper.Keeper
...
func NewVaultGenesisSetupTestHelperV107(k keeper.Keeper) *VaultManagerTestHelpKeeperV107 {
	return &VaultManagerTestHelpKeeperV107{
		Keeper: k,
	}
}

func (h *VaultManagerTestHelpKeeperV107) GetNetwork(ctx cosmos.Context) (Network, error) {
	if h.failGetNetwork {
...
func (h *VaultManagerTestHelpKeeperV107) GetAsgardVaults(ctx cosmos.Context) (Vaults, error) {
...
func (h *VaultManagerTestHelpKeeperV107) ListActiveValidators(ctx cosmos.Context) (NodeAccounts, error) {
...
func (h *VaultManagerTestHelpKeeperV107) SetVault(ctx cosmos.Context, v Vault) error {
	if h.failToSetVault {
		return errKaboom
	}
...
func (h *VaultManagerTestHelpKeeperV107) GetAsgardVaultsByStatus(ctx cosmos.Context, vs VaultStatus) (Vaults, error) {
...
func (h *VaultManagerTestHelpKeeperV107) SetPool(ctx cosmos.Context, p Pool) error {
	if h.failToSetPool {
		return errKaboom
	}
...
func (h *VaultManagerTestHelpKeeperV107) GetTotalLiquidityFees(ctx cosmos.Context, height uint64) (cosmos.Uint, error) {
...
func (h *VaultManagerTestHelpKeeperV107) GetPools(ctx cosmos.Context) (Pools, error) {
	if h.failGetPools {
...
func (*NetworkManagerV107TestSuite) TestGetTotalActiveBond(c *C) {
	...
	SetupLiquidityBondForTestV105(c, ctx, helper.Keeper, common.BNBAsset, na.BondAddress, na, cosmos.NewUint(100*common.One))
...
func (s *NetworkManagerV107TestSuite) TestSynthCycle(c *C) {
	var err error
	ctx, mgr := setupManagerForTest(c)
...
func (s *NetworkManagerV107TestSuite) TestCalcSynthYield(c *C) {
	ctx, mgr := setupManagerForTest(c)
	net := newNetworkMgrV107(mgr.Keeper(), mgr.TxOutStore(), mgr.EventMgr())
...
func (s *NetworkManagerV107TestSuite) TestRagnarokPool(c *C) {
	...
	SetupLiquidityBondForTestV105(c, ctx, k, common.BNBAsset, common.Address(na.NodeAddress.String()), na, cosmos.NewUint(100*common.One))
