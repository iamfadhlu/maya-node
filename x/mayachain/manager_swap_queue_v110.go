...
// SwapQueueV110 is going to manage the swaps queue
type SwapQueueV110 struct {
	k keeper.Keeper
}

// newSwapQueueV110 create a new vault manager
func newSwapQueueV110(k keeper.Keeper) *SwapQueueV110 {
	return &SwapQueueV110{k: k}
}

// FetchQueue - grabs all swap queue items from the kvstore and returns them
func (vm *SwapQueueV110) FetchQueue(ctx cosmos.Context, mgr Manager) (swapItems, error) { // nolint
...
func (vm *SwapQueueV110) EndBlock(ctx cosmos.Context, mgr Manager) error {
...
func (vm *SwapQueueV110) getTodoNum(queueLen, minSwapsPerBlock, maxSwapsPerBlock int64) int64 {
...
// swapItem list
func (vm *SwapQueueV110) scoreMsgs(ctx cosmos.Context, items swapItems, synthVirtualDepthMult int64, mgr Manager) (swapItems, error) {
...
func (vm *SwapQueueV110) getLiquidityFeeAndSlip(ctx cosmos.Context, pool Pool, sourceCoin common.Coin, item *swapItem, virtualDepthMult int64, mgr Manager) {
