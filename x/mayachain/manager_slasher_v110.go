...
// SlasherV110 is v110 implementation of slasher
type SlasherV110 struct {
	keeper   keeper.Keeper
	eventMgr EventManager
}

// newSlasherV110 create a new instance of Slasher
func newSlasherV110(keeper keeper.Keeper, eventMgr EventManager) *SlasherV110 {
	return &SlasherV110{keeper: keeper, eventMgr: eventMgr}
}

// BeginBlock called when a new block get proposed to detect whether there are duplicate vote
func (s *SlasherV110) BeginBlock(ctx cosmos.Context, req abci.RequestBeginBlock, constAccessor constants.ConstantValues) {
...
func (s *SlasherV110) HandleDoubleSign(ctx cosmos.Context, addr crypto.Address, infractionHeight int64, constAccessor constants.ConstantValues) error {
...
func (s *SlasherV110) LackObserving(ctx cosmos.Context, constAccessor constants.ConstantValues) error {
...
func (s *SlasherV110) slashNotObserving(ctx cosmos.Context, txHash common.TxID, constAccessor constants.ConstantValues) error {
...
func (s *SlasherV110) checkSignerAndSlash(ctx cosmos.Context, nodes NodeAccounts, blockHeight int64, signers []cosmos.AccAddress, constAccessor constants.ConstantValues) {
...
func (s *SlasherV110) LackSigning(ctx cosmos.Context, mgr Manager) error {
	var resultErr error
...
func (s *SlasherV110) IncSlashPoints(ctx cosmos.Context, point int64, addresses ...cosmos.AccAddress) {
...
func (s *SlasherV110) DecSlashPoints(ctx cosmos.Context, point int64, addresses ...cosmos.AccAddress) {
	for _, addr := range addresses {
...
func (s *SlasherV110) SlashVaultToLP(ctx cosmos.Context, vaultPK common.PubKey, coins common.Coins, mgr Manager, subsidize bool) error {
	if coins.IsEmpty() {
		return nil
	}
...
func (s *SlasherV110) SlashNodeAccountLP(ctx cosmos.Context, na NodeAccount, slash cosmos.Uint) (cosmos.Uint, []types.PoolAmt, error) {
	if slash.IsZero() {
...
func (s *SlasherV110) needsNewVault(ctx cosmos.Context, mgr Manager, nas int, signingTransPeriod, startHeight int64, inhash common.TxID, pk common.PubKey) bool {
