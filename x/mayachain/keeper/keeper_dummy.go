...
func (k KVStoreDummy) GetCACAOPool(ctx cosmos.Context) (CACAOPool, error) {
	return CACAOPool{}, kaboom
}

func (k KVStoreDummy) SetCACAOPool(ctx cosmos.Context, rp CACAOPool) {}

func (k KVStoreDummy) GetCACAOProvider(ctx cosmos.Context, addr cosmos.AccAddress) (CACAOProvider, error) {
	return CACAOProvider{}, kaboom
}
func (k KVStoreDummy) SetCACAOProvider(ctx cosmos.Context, rp CACAOProvider)       {}
func (k KVStoreDummy) GetCACAOProviderIterator(ctx cosmos.Context) cosmos.Iterator { return nil }
func (k KVStoreDummy) RemoveCACAOProvider(ctx cosmos.Context, rp CACAOProvider)    {}
...
func (k KVStoreDummy) ListValidatorsByStatuses(_ cosmos.Context, _ ...NodeStatus) (NodeAccounts, error) {
	return nil, kaboom
}
...
func (k KVStoreDummy) GetMimir(_ cosmos.Context, key string) (int64, error) { return -1, kaboom }
...
func (k KVStoreDummy) ForceSetLastObserveHeight(ctx cosmos.Context, chain common.Chain, address cosmos.AccAddress, height int64) error {
	return kaboom
}

func (k KVStoreDummy) ForceSetLastChainHeight(ctx cosmos.Context, chain common.Chain, height int64) error {
	return kaboom
}
...
func (k KVStoreDummy) GetLPLiquidityBond(ctx cosmos.Context, bondAddr common.Address, nodeAddr cosmos.AccAddress) (cosmos.Uint, LiquidityProviders, error) {
	return cosmos.ZeroUint(), nil, nil
}
