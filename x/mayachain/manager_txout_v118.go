...
// TxOutStorageV118 is going to manage all the outgoing tx
type TxOutStorageV118 struct {
...
// newTxOutStorageV118 will create a new instance of TxOutStore.
func newTxOutStorageV118(keeper keeper.Keeper, constAccessor constants.ConstantValues, eventMgr EventManager, gasManager GasManager) *TxOutStorageV118 {
	return &TxOutStorageV118{
		keeper:        keeper,
		eventMgr:      eventMgr,
...
func (tos *TxOutStorageV118) EndBlock(ctx cosmos.Context, mgr Manager) error {
...
func (tos *TxOutStorageV118) GetBlockOut(ctx cosmos.Context) (*TxOut, error) {
	return tos.keeper.GetTxOut(ctx, ctx.BlockHeight())
}

// GetOutboundItems read all the outbound item from kv store
func (tos *TxOutStorageV118) GetOutboundItems(ctx cosmos.Context) ([]TxOutItem, error) {
...
func (tos *TxOutStorageV118) GetOutboundItemByToAddress(ctx cosmos.Context, to common.Address) []TxOutItem {
...
func (tos *TxOutStorageV118) ClearOutboundItems(ctx cosmos.Context) {
...
func (tos *TxOutStorageV118) TryAddTxOutItem(ctx cosmos.Context, mgr Manager, toi TxOutItem, minOut cosmos.Uint) (bool, error) {
...
func (tos *TxOutStorageV118) takeAffiliateFee(ctx cosmos.Context, mgr Manager, toi TxOutItem) (cosmos.Uint, error) {
...
func (tos *TxOutStorageV118) cachedTryAddTxOutItem(ctx cosmos.Context, mgr Manager, toi TxOutItem, minOut cosmos.Uint) (bool, error) {
...
// fee deduction, etc
func (tos *TxOutStorageV118) UnSafeAddTxOutItem(ctx cosmos.Context, mgr Manager, toi TxOutItem, height int64) error {
	return tos.addToBlockOut(ctx, mgr, toi, height)
}

func (tos *TxOutStorageV118) discoverOutbounds(ctx cosmos.Context, transactionFeeAsset cosmos.Uint, maxGasAsset common.Coin, toi TxOutItem, vaults Vaults) ([]TxOutItem, cosmos.Uint) {
...
func (tos *TxOutStorageV118) prepareTxOutItem(ctx cosmos.Context, toi TxOutItem) ([]TxOutItem, cosmos.Uint, error) {
	var outputs []TxOutItem
...
func (tos *TxOutStorageV118) addToBlockOut(ctx cosmos.Context, mgr Manager, item TxOutItem, outboundHeight int64) error {
...
func (tos *TxOutStorageV118) CalcTxOutHeight(ctx cosmos.Context, version semver.Version, toi TxOutItem) (int64, error) {
...
func (tos *TxOutStorageV118) nativeTxOut(ctx cosmos.Context, mgr Manager, toi TxOutItem) error {
...
func (tos *TxOutStorageV118) collectYggdrasilPools(ctx cosmos.Context, tx ObservedTx, gasAsset common.Asset) (Vaults, error) {
