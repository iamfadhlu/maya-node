...
func (vm *NetworkMgrV107) synthYieldCycle(ctx cosmos.Context, mgr Manager, yieldPts int64) error {
...
func (vm *NetworkMgrV107) calcSynthYield(ctx cosmos.Context, mgr Manager, yieldPts int64, bucket Pool) cosmos.Uint {
...
func (vm *NetworkMgrV107) calcBlockRewards(ctx cosmos.Context, totalProvidedLiquidity, totalBonded, totalLiquidityFees cosmos.Uint) (cosmos.Uint, cosmos.Uint) {
