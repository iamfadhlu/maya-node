...
func DexAggregatorsV118() []Aggregator {
	return []Aggregator{
		// -------- Rango Exchange --------
		...
		// RangoDiamond Arbitrum
		{common.ARBChain, `0x69460570c93f9DE5E2edbC3052bf10125f0Ca22d`, 400_000},
		...
		// TSAggregatorTokenTransferProxy Arbitrum
		{common.ARBChain, `0x8bAF33E755Ee29E5E37F370a11A0a889DaC5d5f7`, 400_000},
		// TSAggregatorGeneric_V1 Arbitrum
		{common.ARBChain, `0x6e5Add41C751e89432CdA5763156A3f41F1b17aC`, 400_000},
		// TSAggregatorUniswap_V2 Arbitrum
		{common.ARBChain, `0xE378FBDed20d6A21A61a7B84189265F4944fBb70`, 400_000},
		// TSAggregatorUniswapV3_V1 100 - short notation Arbitrum
		{common.ARBChain, `0x33d241aB15c2861347fB886Ff6C4A90aB99c463B`, 400_000},
		// TSAggregatorUniswapV3_V1 500 - short notation Arbitrum
		{common.ARBChain, `0x4D32857A09df8D4ef610B9cDc9450E28b900fEC6`, 400_000},
		// TSAggregatorUniswapV3_V1 3000 - short notation Arbitrum
		{common.ARBChain, `0x50Cbe1330100df9086F6fBc994a300b75dd78012`, 400_000},
		// TSAggregatorUniswapV3_V1 10000 - short notation Arbitrum
		{common.ARBChain, `0x2F661FE1441FE5dD9197660c9030FE71b9632E60`, 400_000},

		// -------- Others --------
		// TransitSwapRouterV5 Ethereum
		{common.ETHChain, `0x00000047bB99ea4D791bb749D970DE71EE0b1A34`, 100_000},
		// TransitSwapRouterV5 Arbitrum
		{common.ARBChain, `0x07964f135f276412b3182a3B2407b8dd45000000`, 100_000},
		// Unizen (Prod) - ETH
