...
// validatorMgrV107 is to manage a list of validators , and rotate them
type validatorMgrV107 struct {
	k                  keeper.Keeper
...
// newValidatorMgrV107 create a new instance of validatorMgrV107
func newValidatorMgrV107(k keeper.Keeper, networkMgr NetworkManager, txOutStore TxOutStore, eventMgr EventManager) *validatorMgrV107 {
	return &validatorMgrV107{
		k:          k,
...
func (vm *validatorMgrV107) BeginBlock(ctx cosmos.Context, mgr Manager, existingValidators []string) error {
...
// asgard vaults
func (vm *validatorMgrV107) splitNext(ctx cosmos.Context, nas NodeAccounts, asgardSize int64) []NodeAccounts {
...
func (vm *validatorMgrV107) EndBlock(ctx cosmos.Context, mgr Manager) []abci.ValidatorUpdate {
	height := ctx.BlockHeight()
...
func (vm *validatorMgrV107) checkContractUpgrade(ctx cosmos.Context, mgr Manager, removedNodeKeys common.PubKeys) error {
...
func (vm *validatorMgrV107) getChangedNodes(ctx cosmos.Context, activeNodes NodeAccounts) (NodeAccounts, NodeAccounts, error) {
...
func (vm *validatorMgrV107) payNodeAccountBondAward(ctx cosmos.Context, lastChurnHeight int64, na NodeAccount, nodeReward, nodeBond sdk.Uint, bpBonds []sdk.Uint, mgr Manager) error {
	...
	if !nodeOperatorFees.IsZero() {
		reward = common.SafeSub(na.Reward, nodeOperatorFees)
	}

	// FIXME migration code to deprecate na.Reward, remove after v107
...
func (vm *validatorMgrV107) processRagnarok(ctx cosmos.Context, mgr Manager) error {
...
func (vm *validatorMgrV107) getPendingTxOut(ctx cosmos.Context, constAccessor constants.ConstantValues) (int64, error) {
...
func (vm *validatorMgrV107) ragnarokBondReward(ctx cosmos.Context, mgr Manager) error {
	var resultErr error
...
func (vm *validatorMgrV107) ragnarokPools(ctx cosmos.Context, nth int64, mgr Manager) error {
	nas, err := vm.k.ListActiveValidators(ctx)
	if err != nil {
...
func (vm *validatorMgrV107) RequestYggReturn(ctx cosmos.Context, node NodeAccount, mgr Manager) error {
...
func (vm *validatorMgrV107) recallYggFunds(ctx cosmos.Context, mgr Manager) error {
...
func (vm *validatorMgrV107) setupValidatorNodes(ctx cosmos.Context, height int64, constAccessor constants.ConstantValues) error {
	if height != genesisBlockHeight {
...
func (vm *validatorMgrV107) getLastChurnHeight(ctx cosmos.Context) int64 {
	vaults, err := vm.k.GetAsgardVaultsByStatus(ctx, ActiveVault)
	if err != nil {
		ctx.Logger().Error("Failed to get Asgard vaults", "error", err)
...
func (vm *validatorMgrV107) getScore(ctx cosmos.Context, slashPts, lastChurnHeight int64) cosmos.Uint {
...
func (vm *validatorMgrV107) findBadActors(ctx cosmos.Context, minSlashPointsForBadValidator, badValidatorRedline int64) (NodeAccounts, error) {
...
func (vm *validatorMgrV107) findOldActor(ctx cosmos.Context) (NodeAccount, error) {
	na := NodeAccount{}
	nas, err := vm.k.ListActiveValidators(ctx)
	if err != nil {
		return na, err
...
func (vm *validatorMgrV107) findLowBondActor(ctx cosmos.Context) (NodeAccount, error) {
	na := NodeAccount{}
	nas, err := vm.k.ListActiveValidators(ctx)
	if err != nil {
		return na, err
...
func (vm *validatorMgrV107) markActor(ctx cosmos.Context, na NodeAccount, reason string) error {
...
func (vm *validatorMgrV107) markOldActor(ctx cosmos.Context) error {
...
func (vm *validatorMgrV107) markLowBondActor(ctx cosmos.Context) error {
...
func (vm *validatorMgrV107) markBadActor(ctx cosmos.Context, minSlashPointsForBadValidator, redline int64) error {
...
func (vm *validatorMgrV107) markLowVersionValidators(ctx cosmos.Context, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV107) findLowVersionValidators(ctx cosmos.Context, maxNodesToFind int64) (NodeAccounts, error) {
...
func (vm *validatorMgrV107) markReadyActors(ctx cosmos.Context, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV107) NodeAccountPreflightCheck(ctx cosmos.Context, na NodeAccount, constAccessor constants.ConstantValues) (NodeStatus, error) {
...
func (vm *validatorMgrV107) nextVaultNodeAccounts(ctx cosmos.Context, targetCount int, constAccessor constants.ConstantValues) (NodeAccounts, bool, error) {
