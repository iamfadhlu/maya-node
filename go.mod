...
replace github.com/ethereum/go-ethereum => gitlab.com/mayachain/arbitrum/go-ethereum/v3 v3.6.0
...
require (
	...
	github.com/radixdlt/maya v1.3.1
	github.com/radixdlt/radix-engine-toolkit-go/v2 v2.1.1
