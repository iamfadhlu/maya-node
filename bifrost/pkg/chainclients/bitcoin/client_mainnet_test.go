...
func (s *BitcoinSuite) TestGetConfirmationCount(c *C) {
	...
	s.client.bridge = shared.NewMockMayaChainBridge()
		...
		TxArray: []types.TxInItem{
			{
				...
				To:          "bc1q2gjc0rnhy4nrxvuklk6ptwkcs9kcr59mcl2q9j",
				Coins: common.Coins{
					common.NewCoin(common.BTCAsset, cosmos.NewUint(323456000)),
				},
				Memo:                "MEMO",
				ObservedVaultPubKey: pkey,
			},
	...
	// test max confirmation adjustment
	c.Assert(s.client.GetConfirmationCount(types.TxIn{
		Chain: common.BTCChain,
		TxArray: []types.TxInItem{
			{
				...
				To:          "bc1q2gjc0rnhy4nrxvuklk6ptwkcs9kcr59mcl2q9j",
				Coins: common.Coins{
					common.NewCoin(common.BTCAsset, cosmos.NewUint(1234567000)),
				},
				Memo:                "MEMO",
				ObservedVaultPubKey: pkey,
			},
