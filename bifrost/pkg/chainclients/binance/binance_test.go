...
func (s *BinancechainSuite) TestSignTx(c *C) {
  ...
  "tmayapub1addwnpepqwhnus6xs4208d4ynm05lv493amz3fexfjfx4vptntedd7k0ajlcu40le0r"
	...
	c.Assert(err, IsNil)
	txOut := getTxOutFromJsonInput(`{ "height": 1718, "hash": "", "tx_array": [ { "vault_pub_key":"tmayapub1addwnpepq2jgpsw2lalzuk7sgtmyakj7l6890f5cfpwjyfp8k4y4t7cw2vk8vvgpt43","to_address": "tbnb1hzwfk6t3sqjfuzlr0ur9lj920gs37gg92gtay9", "coin":  { "asset": "BNB", "amount": "194765912" }  } ]}`, c)
