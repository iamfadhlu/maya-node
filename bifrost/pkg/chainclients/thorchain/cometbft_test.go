...
func (m *mockCometBFTRPC) Block(ctx context.Context, height *int64) (*ctypes.ResultBlock, error) {
...
func (m *mockCometBFTRPC) BlockResults(ctx context.Context, height *int64) (*ctypes.ResultBlockResults, error) {
