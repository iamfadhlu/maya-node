...
func (t *TssServer) waitForSignatures(msgID, poolPubKey string, msgsToSign [][]byte, algo mcommon.SigningAlgo, sigChan chan string) (keysign.Response, error) {
...
func (t *TssServer) generateSignature(
	...
	return t.batchSignatures(mcommon.SigningAlgo(req.Algo), signatureData, msgsToSign), nil
}
...
func (t *TssServer) KeySign(req keysign.Request) (keysign.Response, error) {
	...
	algo := mcommon.SigningAlgo(req.Algo)
...
func (t *TssServer) batchSignatures(algo mcommon.SigningAlgo, sigs []*tsslibcommon.SignatureData, msgsToSign [][]byte) keysign.Response {
