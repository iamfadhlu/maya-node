...
func TestGetPubKeysFromPeerIDs(t *testing.T) {
	...
	assert.Equal(t, "mayapub1addwnpepqtctt9l4fddeh0krvdpxmqsxa5z9xsa0ac6frqfhm9fq6c6u5lck5khlyuq", result[0])
	assert.Equal(t, "mayapub1addwnpepqga5cupfejfhtw507sh36fvwaekyjt5kwaw0cmgnpku0at2a87qqk82e5uz", result[1])
...
func (KeyProviderTestSuite) TestGetPeerIDs(c *C) {
	pubKeys := []string{
		"mayapub1addwnpepqtctt9l4fddeh0krvdpxmqsxa5z9xsa0ac6frqfhm9fq6c6u5lck5khlyuq",
		"mayapub1addwnpepqga5cupfejfhtw507sh36fvwaekyjt5kwaw0cmgnpku0at2a87qqk82e5uz",
	}
...
func (KeyProviderTestSuite) TestGetPeerIDFromPubKey(c *C) {
	pID, err := GetPeerIDFromPubKey("mayapub1addwnpepqtctt9l4fddeh0krvdpxmqsxa5z9xsa0ac6frqfhm9fq6c6u5lck5khlyuq")
	c.Assert(err, IsNil)
...
func (KeyProviderTestSuite) TestCheckKeyOnCurve(c *C) {
	...
	c.Assert(err, NotNil)
	SetupBech32Prefix()
	_, err = CheckKeyOnCurve("mayapub1addwnpepqtctt9l4fddeh0krvdpxmqsxa5z9xsa0ac6frqfhm9fq6c6u5lck5khlyuq")
	c.Assert(err, IsNil)
}
