...
func (p *ConversionTestSuite) TestTssPubKey(c *C) {
	...
	c.Assert(err, IsNil)
	c.Assert(pk, Equals, "mayapub1addwnpepq2dwek9hkrlxjxadrlmy9fr42gqyq6029q0hked46l3u6a9fxqel6dttts0")
	c.Assert(addr.String(), Equals, "maya17l7cyxqzg4xymnl0alrhqwja276s3rns37vp6t")
}
