...
func (s *FileStateMgrTestSuite) TestNewFileStateMgr(c *C) {
	...
	c.Assert(err, NotNil)
	fileName, err = fsm.getFilePathName("mayapub1addwnpepqf90u7n3nr2jwsw4t2gzhzqfdlply8dlzv3mdj4dr22uvhe04azq5wdwwpn")
	c.Assert(err, IsNil)
	c.Assert(fileName, Equals, filepath.Join(f, "localstate-mayapub1addwnpepqf90u7n3nr2jwsw4t2gzhzqfdlply8dlzv3mdj4dr22uvhe04azq5wdwwpn.json"))
}
...
func (s *FileStateMgrTestSuite) TestSaveLocalState(c *C) {
	...
	stateItem.PubKey = "mayapub1addwnpepqf90u7n3nr2jwsw4t2gzhzqfdlply8dlzv3mdj4dr22uvhe04azq5wdwwpn"
