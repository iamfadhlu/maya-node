...
func (s *EddsaKeysignTestSuite) TestSignMessage(c *C) {
	...
	req := keysign.NewRequest("mayapub1addwnpepqv6xp3fmm47dfuzglywqvpv8fdjv55zxte4a26tslcezns5czv586u2fw33", mcommon.SigningAlgoEd25519, []string{"helloworld-test", "t"}, 10, testPubKeys, "")
