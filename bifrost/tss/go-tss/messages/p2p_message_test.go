...
type MAYAChainTSSMessageTypeSuite struct{}

var _ = Suite(&MAYAChainTSSMessageTypeSuite{})

func (MAYAChainTSSMessageTypeSuite) TestMAYAChainTSSMessageType_String(c *C) {
	m := map[MAYAChainTSSMessageType]string{
...
func (MAYAChainTSSMessageTypeSuite) TestWireMessage(c *C) {
