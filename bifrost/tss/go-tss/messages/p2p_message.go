...
// MAYAChainTSSMessageType  represent the messgae type used in MAYAChain TSS
type MAYAChainTSSMessageType uint8

const (
	// TSSKeyGenMsg is the message directly generated by tss-lib package
	TSSKeyGenMsg MAYAChainTSSMessageType = iota
...
func (msgType MAYAChainTSSMessageType) String() string {
	switch msgType {
	case TSSKeyGenMsg:
		return "TSSKeyGenMsg"
	case TSSKeySignMsg:
...
type WrappedMessage struct {
	MessageType MAYAChainTSSMessageType `json:"message_type"`
...
type TssControl struct {
	...
	RequestType MAYAChainTSSMessageType `json:"request_type"`
