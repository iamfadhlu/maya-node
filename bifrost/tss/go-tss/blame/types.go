...
// *** Blame struct had been referenced and registered in mayanode , so please don't change this structure, otherwise it will have consensus failure when trying to update mayanode  ***
type Blame struct {
