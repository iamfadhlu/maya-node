...
import (
	...
	"gitlab.com/mayachain/mayanode/bifrost/db"
...
func NewSignerStore(levelDbFolder string, opts config.LevelDBOptions, passphrase string) (*SignerStore, error) {
	...
	if entropy < 50.0 {
		return nil, errors.New(
			"Signer passphrase very weak, change either length or complexity by adding special characters, numbers, lower and/or uppercase letters",
		)
	}
	return &SignerStore{
