...
func Init() {
	...
	assert(viper.BindEnv("bifrost.mayachain.signer_name_eddsa", "SIGNER_NAME_EDDSA"))
	...
	assert(viper.BindEnv(
		"bifrost.chains.ARB.block_scanner.rpc_host",
		"ARB_HOST",
	))
	assert(viper.BindEnv(
	...
	assert(viper.BindEnv(
		"bifrost.chains.ZEC.rpc_host",
		"ZCASH_HOST",
	))
	assert(viper.BindEnv(
		"bifrost.chains.ZEC.block_scanner.rpc_host",
		"ZCASH_HOST",
	))
	assert(viper.BindEnv(
		"bifrost.chains.ZEC.block_scanner.start_block_height",
		"ZCASH_START_BLOCK_HEIGHT",
	))
	assert(viper.BindEnv(
	...
	assert(viper.BindEnv(
		"bifrost.chains.KUJI.rpc_host",
		"KUJI_HOST",
	))
	assert(viper.BindEnv(
		"bifrost.chains.KUJI.block_scanner.rpc_host",
		"KUJI_HOST",
	))
	assert(viper.BindEnv(
	...
	assert(viper.BindEnv(
		"bifrost.chains.THOR.block_scanner.chain_api",
		"THOR_API",
	))
	assert(viper.BindEnv(
	...
	assert(viper.BindEnv(
		"bifrost.chains.KUJI.block_scanner.start_block_height",
		"KUJI_START_BLOCK_HEIGHT",
	))
	assert(viper.BindEnv(
		"bifrost.chains.KUJI.cosmos_grpc_host",
		"KUJI_GRPC_HOST",
	))
	assert(viper.BindEnv(
		"bifrost.chains.KUJI.block_scanner.cosmos_grpc_host",
		"KUJI_GRPC_HOST",
	))
	assert(viper.BindEnv(
		"bifrost.chains.KUJI.cosmos_grpc_tls",
		"KUJI_GRPC_TLS",
	))
	assert(viper.BindEnv(
		"bifrost.chains.KUJI.block_scanner.cosmos_grpc_tls",
		"KUJI_GRPC_TLS",
	))
	assert(viper.BindEnv(
		"bifrost.chains.KUJI.block_scanner.start_block_height",
	...
	assert(viper.BindEnv(
		"bifrost.chains.XRD.rpc_host",
		"XRD_HOST",
	))
	assert(viper.BindEnv(
		"bifrost.chains.XRD.block_scanner.rpc_host",
		"XRD_HOST",
	))
	assert(viper.BindEnv(
		"bifrost.chains.XRD.block_scanner.start_block_height",
		"XRD_START_BLOCK_HEIGHT",
	))
	assert(viper.BindEnv("bifrost.chains.KUJI.disabled", "KUJI_DISABLED"))
	...
	assert(viper.BindEnv("bifrost.chains.ZEC.disabled", "ZCASH_DISABLED"))
	...
	assert(viper.BindEnv("bifrost.chains.ARB.disabled", "ARB_DISABLED"))
	assert(viper.BindEnv("bifrost.chains.XRD.disabled", "XRD_DISABLED"))
