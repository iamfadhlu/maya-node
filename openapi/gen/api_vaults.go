...
func (a *VaultsApiService) AsgardExecute(r ApiAsgardRequest) ([]Vault, *http.Response, error) {
	...
	localVarPath := localBasePath + "/mayachain/vaults/asgard"
...
func (a *VaultsApiService) VaultExecute(r ApiVaultRequest) (*Vault, *http.Response, error) {
	...
	localVarPath := localBasePath + "/mayachain/vault/{pubkey}"
...
func (a *VaultsApiService) VaultPubkeysExecute(r ApiVaultPubkeysRequest) (*VaultPubkeysResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/mayachain/vaults/pubkeys"
...
func (a *VaultsApiService) YggdrasilExecute(r ApiYggdrasilRequest) ([]Vault, *http.Response, error) {
	...
	localVarPath := localBasePath + "/mayachain/vaults/yggdrasil"
