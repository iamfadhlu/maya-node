...
func (a *TransactionsApiService) TxExecute(r ApiTxRequest) (*TxResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/mayachain/tx/{hash}"
...
type ApiTxInVoterRequest struct {
	ctx context.Context
	ApiService *TransactionsApiService
	hash string
	height *int64
...
// optional block height, defaults to current tip
func (r ApiTxInVoterRequest) Height(height int64) ApiTxInVoterRequest {
	r.height = &height
	return r
}

func (r ApiTxInVoterRequest) Execute() (*TxDetailsResponse, *http.Response, error) {
	return r.ApiService.TxInVoterExecute(r)
}

/*
TxInVoter Method for TxInVoter

Returns the inbound transaction voter for a provided hash.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param hash
 @return ApiTxInVoterRequest
*/
func (a *TransactionsApiService) TxInVoter(ctx context.Context, hash string) ApiTxInVoterRequest {
	return ApiTxInVoterRequest{
		ApiService: a,
		ctx: ctx,
		hash: hash,
...
func (a *TransactionsApiService) TxInVoterExecute(r ApiTxInVoterRequest) (*TxDetailsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransactionsApiService.TxInVoter")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/mayachain/tx/in/{hash}"
	localVarPath = strings.Replace(localVarPath, "{"+"hash"+"}", url.PathEscape(parameterToString(r.hash, "")), -1)
...
type ApiTxOutVoterRequest struct {
	ctx context.Context
	ApiService *TransactionsApiService
	hash string
	height *int64
...
// optional block height, defaults to current tip
func (r ApiTxOutVoterRequest) Height(height int64) ApiTxOutVoterRequest {
	r.height = &height
	return r
}

func (r ApiTxOutVoterRequest) Execute() (*TxDetailsResponse, *http.Response, error) {
	return r.ApiService.TxOutVoterExecute(r)
}

/*
TxOutVoter Method for TxOutVoter

Returns the outbound transaction voter for a provided hash.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param hash
 @return ApiTxOutVoterRequest
*/
func (a *TransactionsApiService) TxOutVoter(ctx context.Context, hash string) ApiTxOutVoterRequest {
	return ApiTxOutVoterRequest{
		ApiService: a,
		ctx: ctx,
		hash: hash,
...
// Execute executes the request
//  @return TxDetailsResponse
func (a *TransactionsApiService) TxOutVoterExecute(r ApiTxOutVoterRequest) (*TxDetailsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransactionsApiService.TxOutVoter")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/mayachain/tx/out/{hash}"
	localVarPath = strings.Replace(localVarPath, "{"+"hash"+"}", url.PathEscape(parameterToString(r.hash, "")), -1)
...
func (a *TransactionsApiService) TxSignersExecute(r ApiTxSignersRequest) (*TxDetailsResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/mayachain/tx/details/{hash}"
	localVarPath = strings.Replace(localVarPath, "{"+"hash"+"}", url.PathEscape(parameterToString(r.hash, "")), -1)
...
func (a *TransactionsApiService) TxSignersOldExecute(r ApiTxSignersOldRequest) (*TxSignersResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/mayachain/tx/{hash}/signers"
	localVarPath = strings.Replace(localVarPath, "{"+"hash"+"}", url.PathEscape(parameterToString(r.hash, "")), -1)
...
func (a *TransactionsApiService) TxStagesExecute(r ApiTxStagesRequest) (*TxStagesResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/mayachain/tx/stages/{hash}"
	localVarPath = strings.Replace(localVarPath, "{"+"hash"+"}", url.PathEscape(parameterToString(r.hash, "")), -1)
...
func (a *TransactionsApiService) TxStatusExecute(r ApiTxStatusRequest) (*TxStatusResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/mayachain/tx/status/{hash}"
	localVarPath = strings.Replace(localVarPath, "{"+"hash"+"}", url.PathEscape(parameterToString(r.hash, "")), -1)
