...
class MockBitcoin(HttpClient):
    ...
    private_keys = [
        "0e4103112ae8f1b835ef3b6b80fe243ec5896c163e8617d8bd6ab5820779e3a6",
    ...
    def create_wallet(self):
        ...
        if len(wallets) == 0:
            self.call("createwallet", "", False, False, "", False, False, False)
...
class Bitcoin(GenericChain):
    ...
    def _calculate_gas(cls, pool, txn):
        ...
        1 CACAO / 2 in BTC value
        """
        if pool is None:
            return Coin(cls.coin, MockBitcoin.default_gas)

        btc_amount = pool.get_cacao_in_asset(int(cls.cacao_fee / 2))
