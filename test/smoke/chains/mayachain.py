...
class MockMayachain(HttpClient):
    ...
    chain = "MAYA"
    mnemonic = {
        "USER-1": "vintage announce rapid clip spare stomach matter camp noble habit beef amateur chimney time fuel machine culture end toe oval isolate laptop solar gift",
        "PROVIDER-1": "discover blue crunch cart club fish airport crazy roast hybrid scheme picnic veteran mango beach narrow luxury glory dynamic crawl symbol win sell dress",
