...
var funcMap = template.FuncMap{
	...
	"addr_module_mayachain": func() string {
		return ModuleAddrMayachain
	},
	...
	"addr_module_cacao_pool": func() string {
		return ModuleAddrCacaoPool
	},
	"addr_module_maya_fund": func() string {
		return ModuleAddrMayaFund
	},
}
